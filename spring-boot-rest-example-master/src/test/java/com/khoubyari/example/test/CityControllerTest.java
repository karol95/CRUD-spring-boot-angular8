...
import com.khoubyari.example.api.rest.CityController;
...
public class CityControllerTest {
    private static final String RESOURCE_LOCATION_PATTERN = "http://localhost/example/v1/cities/[0-9]+";
    ...
    public void shouldHaveEmptyDB() throws Exception {
        mvc.perform(get("/example/v1/cities")
    ...
    public void shouldCreateRetrieveDelete() throws Exception {
        ...
        //CREATE
        MvcResult result = mvc.perform(post("/example/v1/cities")
                .content(r1Json)
        ...
        //RETRIEVE
        mvc.perform(get("/example/v1/cities/" + id)
                .accept(MediaType.APPLICATION_JSON))
                .andExpect(status().isOk())
                .andExpect(jsonPath("$.id", is((int) id)))
                .andExpect(jsonPath("$.name", is(r1.getName())))
                .andExpect(jsonPath("$.description", is(r1.getDescription())))
                .andExpect(jsonPath("$.length", is(r1.getLength())));

        //DELETE
        mvc.perform(delete("/example/v1/cities/" + id))
 ...
 */
    ...
    public void shouldCreateAndUpdateAndDelete() throws Exception {
        ...
        //UPDATE
        result = mvc.perform(put("/example/v1/cities/" + id)
                .content(r2Json)
                .contentType(MediaType.APPLICATION_JSON)
                .accept(MediaType.APPLICATION_JSON))
                .andExpect(status().isNoContent())
        ...
        mvc.perform(get("/example/v1/cities/" + id)
                ...
                .andExpect(jsonPath("$.length", is(r2.getLength())));
    ...
    private City mockCity(String prefix) {
        ...
        r.setLength(new Random().nextLong());
        return r;
    }
